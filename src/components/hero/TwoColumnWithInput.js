...
import { ReactComponent as SvgDecoratorBlob2 } from "images/doodledecerator.svg";
...
const DecoratorBlob1 = styled(SvgDecoratorBlob1)`
  ${tw`pointer-events-none opacity-5 absolute left-0 bottom-0 h-64 w-64 transform -translate-x-full -z-10`}
`;

const DecoratorBlob2 = styled(SvgDecoratorBlob2)`
  ${tw`pointer-events-none -z-20 absolute right-0 top-0 h-64 w-64  transform translate-x-2/3 -translate-y-12 text-pink-400`}
`;
